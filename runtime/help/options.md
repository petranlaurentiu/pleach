...
* `keymenu`: display the clickable command bar at the bottom of the screen
   (Tree, Terminal, Agent, Close panel, and related actions). Toggle with
   `Alt-g`. Bind `Alt-g` to `None` to disable that shortcut.
