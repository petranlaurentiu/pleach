...
func InitCommands() {
	commands = map[string]Command{
		...
		"terminal":    {(*BufPane).TerminalCmd, nil},
		"agent":       {(*BufPane).AgentCmd, nil},
		"closepanel":  {(*BufPane).ClosePanelCmd, nil},
		"layout":      {(*BufPane).LayoutCmd, nil},
