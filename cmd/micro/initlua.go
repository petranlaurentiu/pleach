...
func luaImportMicro() *lua.LTable {
	...
	ulua.L.SetField(pkg, "ShowMenu", luar.New(ulua.L, action.ShowMenuLua))
	ulua.L.SetField(pkg, "CopyToClipboard", luar.New(ulua.L, action.CopyToClipboard))
	ulua.L.SetField(pkg, "OpenInEditor", luar.New(ulua.L, action.OpenPathInEditor))
